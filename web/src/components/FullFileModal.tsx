...
export default function FullFileModal({ isOpen, filePath, directory, onClose, viewMode, getCommentsForLine, getCommentRangeLines, onDeleteComment, onUpdateComment, onAddReply, onAddComment, wrapLines = false, diffType = 'all', selectedRevision }: FullFileModalProps): React.ReactElement | null {
